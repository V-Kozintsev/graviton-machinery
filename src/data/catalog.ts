...
const common = {
  ...
  excavator2: { image: 'excavator-2', alt: 'Колесный экскаватор на городской дорожной стройке' },
  loader: { image: 'loader', alt: 'Фронтальный погрузчик на складе щебня' },
  loader2: { image: 'loader-2', alt: 'Средний фронтальный погрузчик на складе строительных материалов' },
  bulldozer: { image: 'bulldozer', alt: 'Бульдозер с широким отвалом на подготовке площадки' },
  bulldozer2: { image: 'bulldozer-2', alt: 'Тяжелый бульдозер с рыхлителем на земляных работах' },
  crane: { image: 'crane', alt: 'Автокран с телескопической стрелой на промышленном объекте' },
  crane2: { image: 'crane-2', alt: 'Автокран с выносными опорами на строительной площадке' },
  road: { image: 'road', alt: 'Дорожная техника на асфальтовой площадке' },
  road2: { image: 'road-2', alt: 'Автогрейдер на строительстве дороги' },
  skid: { image: 'skid', alt: 'Мини-погрузчик на городской строительной площадке' },
  skid2: { image: 'skid-2', alt: 'Мини-погрузчик с паллетными вилами на складе материалов' },
};
...
const rows: Row[] = [
  ...
  ['terra-dig-180', 'TerraDig 180 колесный экскаватор', 'excavators', 'TerraDig', 'GR-EX-180-23', 2023, 'После сервиса', 'В пути', 11900000, 86, common.excavator2, { Масса: '18 200 кг', Мощность: '112 кВт', Ковш: '0,9 м³', 'Глубина копания': '5,9 м', Наработка: '740 м/ч' }, ['18,2 т', '0,9 м³', '740 м/ч']],
  ...
  ['volmar-l50', 'Volmar L50 фронтальный погрузчик', 'loaders', 'Volmar', 'GR-LD-050-22', 2022, 'С пробегом', 'В наличии', 6200000, 78, common.loader2, { Масса: '7 900 кг', Мощность: '92 кВт', Ковш: '1,6 м³', Грузоподъемность: '2 500 кг', Наработка: '1 840 м/ч' }, ['1,6 м³', '2,5 т', '2022 г.']],
  ...
  ['steeltrack-d65', 'SteelTrack D65 бульдозер', 'bulldozers', 'SteelTrack', 'GR-BD-065-21', 2021, 'После сервиса', 'В наличии', 10800000, 75, common.bulldozer2, { Масса: '19 600 кг', Мощность: '153 кВт', Отвал: '4,6 м³', Тяга: '265 кН', Наработка: '2 120 м/ч' }, ['19,6 т', '2 120 м/ч', 'рыхлитель']],
  ...
  ['cranex-50', 'CraneX 50 автокран', 'cranes', 'CraneX', 'GR-CR-050-22', 2022, 'С пробегом', 'Под заказ', null, 69, common.crane2, { Грузоподъемность: '50 т', Стрела: '45 м', Шасси: '8x4', Мощность: '276 кВт', Наработка: '1 360 м/ч' }, ['50 т', '45 м', 'цена по запросу']],
  ...
  ['gradepro-140', 'GradePro 140 автогрейдер', 'road', 'RoadPro', 'GR-RD-140-24', 2024, 'Новая', 'В пути', 18200000, 72, common.road2, { Масса: '15 400 кг', Мощность: '138 кВт', Отвал: '3 660 мм', Рыхлитель: '5 зубьев', Наработка: '16 м/ч' }, ['15,4 т', '3 660 мм', '138 кВт']],
  ...
  ['compact-sk900', 'Compact SK900 мини-погрузчик', 'skid', 'Compact', 'GR-SK-900-22', 2022, 'С пробегом', 'В наличии', 3900000, 73, common.skid2, { Масса: '3 850 кг', Мощность: '63 кВт', Ковш: '0,55 м³', Грузоподъемность: '1 180 кг', Наработка: '1 420 м/ч' }, ['1 180 кг', '2022 г.', '1 420 м/ч']],
];
