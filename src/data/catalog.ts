...
export const catalog: Machine[] = rows.map(([slug, name, category, maker, sku, year, condition, availability, price, popular, media, specs, highlights]) => ({
  ...
  specs,
  highlights,
  description: 'Демонстрационная позиция каталога GRAVITON: техника подготовлена к осмотру, поставляется с предпродажной диагностикой и комплектом документов.',
